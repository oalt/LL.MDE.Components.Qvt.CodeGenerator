...
namespace LL.MDE.Components.Qvt.CodeGenerator.CodeGeneration.UserInterfaceAppTemplate
{
    public partial class UserInterfaceAppMainTemplate
    {
        ...
        public UserInterfaceAppMainTemplate(IRelationalTransformation transformation, bool useMetamodelInterface = true)
        {
