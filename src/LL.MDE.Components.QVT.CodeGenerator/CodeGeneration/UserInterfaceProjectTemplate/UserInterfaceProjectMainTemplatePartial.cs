...
namespace LL.MDE.Components.Qvt.CodeGenerator.CodeGeneration.UserInterfaceProjectTemplate
{
    public partial class UserInterfaceProjectMainTemplate
    {
        ...
        public UserInterfaceProjectMainTemplate(IRelationalTransformation transformation, bool useMetamodelInterface = true)
        {
